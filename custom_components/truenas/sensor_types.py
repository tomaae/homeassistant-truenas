...
SENSOR_TYPES: tuple[TrueNASSensorEntityDescription, ...] = (
    ...
    TrueNASSensorEntityDescription(
        ...
        # suggested_display_precision=0.00,
    ...
    TrueNASSensorEntityDescription(
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="arc_size",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="system_total_memory",
        name="Memory: Total",
        icon="mdi:memory",
    ...
    TrueNASSensorEntityDescription(
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="memory-buffers_value",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="system_swap_total_memory",
        name="SWAP: Total",
        icon="mdi:memory",
        native_unit_of_measurement=UnitOfInformation.GIGABYTES,
        suggested_unit_of_measurement=UnitOfInformation.GIGABYTES,
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="swap-total_value",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="system_swap_free_memory",
        name="SWAP: Free",
        icon="mdi:memory",
        native_unit_of_measurement=UnitOfInformation.GIGABYTES,
        suggested_unit_of_measurement=UnitOfInformation.GIGABYTES,
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="swap-free_value",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="system_swap_used_memory",
        name="SWAP: Used",
        icon="mdi:memory",
        native_unit_of_measurement=UnitOfInformation.GIGABYTES,
        suggested_unit_of_measurement=UnitOfInformation.GIGABYTES,
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="swap-used_value",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="system_swap_memory_usage",
        name="SWAP: Usage",
        icon="mdi:memory",
        native_unit_of_measurement=PERCENTAGE,
        device_class=None,
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="swap-usage_percent",
        data_name="",
        data_uid="",
        data_reference="",
        data_attributes_list=DEVICE_ATTRIBUTES_MEMORY,
    ...
    TrueNASSensorEntityDescription(
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="memory-cached_value",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="system_used_memory",
        name="Memory: Used",
        icon="mdi:memory",
        native_unit_of_measurement=UnitOfInformation.GIGABYTES,
        suggested_unit_of_measurement=UnitOfInformation.GIGABYTES,
        ...
        ha_group="System",
        data_path="system_info",
        data_attribute="memory-used_value",
        data_name="",
        data_uid="",
        data_reference="",
    ),
